<x-app-layout>
    <x-slot name="header">
        <!-- Cabeçalho da página que exibe o título principal -->
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <form action="{{ route('funds.add-prices-form', ['fund' => $fund->id]) }}" method="POST">
                        @csrf
                        <!-- Campo de entrada para preços com data -->
                        <div class="mb-4">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Adiciona uma nova entrada de preço ao clicar no botão "Add Price Entry"
            ...
            // Remove uma entrada de preço ao clicar no botão "Remove"
